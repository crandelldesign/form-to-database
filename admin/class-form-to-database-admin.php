 ...
 * @subpackage Form_to_Database/admin
 */
...
class Form_to_Database_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $form_to_database       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->form_to_database, plugin_dir_url( __FILE__ ) . 'css/form-to-database-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->form_to_database, plugin_dir_url( __FILE__ ) . 'js/form-to-database-admin.js', array( 'jquery' ), $this->version, false );
